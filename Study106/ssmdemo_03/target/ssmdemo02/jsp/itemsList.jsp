    ...
    <script type="text/javascript">
        ...
        function operateData(param){
            ...
            if(index==0){
                ...
                userinfoForm.submit();
            }else if (index>=1 && param=='checkboxEdit') {
                userinfoForm.action='editItems.action';
                userinfoForm.submit();
            }else {
        ...
        <table border="0" align="right">
            <tr>
                <td>
                    ...
                    <input type="button" name="eidbtn" value="更新" onclick="operateData('checkboxEdit')" class="btn">
                </td>
            </tr>
        </table>
        商品列表
