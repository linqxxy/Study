    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#vcodeImg").click(function () {
                this.src = "${pageContext.request.contextPath}/get_cpacha.action?w=160&h=40" + new Date().getTime();
            });
            //登录按钮事件
            ...
            <div class="row cl">
                ...
                <div class="formControls col-8">
                    <input id="verifiCode" class="input-text radius size-L" name="verifiCode" type="text"
                           placeholder="验证码"
                           style="width: 200px;">
                    <img title="点击图片切换验证码 ~" id="vcodeImg" src="${pageContext.request.contextPath}/get_cpacha.action?w=160&h=40" alt="#">
                </div>
            </div>
            <!-- 用户类型 -->
...
<!-- 页面底部版权声明 -->
<div class="footer">
    Copyright @ 2019 Linqxxy. All rights reserved | Blog : https://linqxxy.top
</div>
</body>
</html>